...
import id.my.hendisantika.qrcodegenerator.model.*;
...
import java.util.Base64;            // ✅ use built-in Base64
import java.util.EnumMap;
import java.util.Map;
import java.util.UUID;

/**
 * Compatible with Java 24 – no Spring Base64Utils dependency.
 */
@Component
@Slf4j
public class QrCodeEncoder {
    ...
    private QrCodeProcessingResult generateImageAsBase64(String textToBeEncoded) {
        ...
        try {
            ...
            imageText = "data:image/png;base64," + Base64.getEncoder().encodeToString(bytes);  // ✅ fixed line
